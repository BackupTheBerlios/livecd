	...
	<tr><td bgcolor="#000000">
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			...
			<tr><td bgcolor=#000000 colspan=2>
				...
				&nbsp;&nbsp;|&nbsp;&nbsp;
				<font color=#ffffff>a b o u t</font>
				&nbsp;&nbsp;|&nbsp;&nbsp;
			...
			<tr><td bgcolor="#000000">
				<table width=100% border=0 cellspacing=2 cellpadding=5 cols=2>
					...
					<tr><td colspan=2 bgcolor=#d0d0d0>
						...
						<b>j o i n</b><br>
						The LiveCD project is alway looking for new developers and users. So, what are you waiting for, jump on one of our <a href="http://developer.berlios.de/mail/?group_id=1149">mailing lists</a>.
					</td></tr>
				</table>
			</td></tr>
			<tr><td height="10"></td></tr>
